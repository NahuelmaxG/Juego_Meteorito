...
func _ready() -> void:
	...
	timer_enfriamento.wait_time = cadencia_disparo
...
## Atributos onready
onready var timer_enfriamento:Timer = $TimerEnfriamento
...
func _on_TimerEnfriamento_timeout() -> void:
	esta_enfriado = true
